...
import { RabbitMQMessages } from '@enums'
...
export class RabbitmqController {
  ...
  @EventPattern(RabbitMQMessages.worker_fines_event)
  handleFineCreated(@Payload() data: FineCreatedMessageDto[], @Ctx() context: RmqContext) {
